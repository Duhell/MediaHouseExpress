<section class="w-full px-5 md:px-0 h-[741px] relative overflow-hidden">
    <img class="absolute inset-0 w-full h-full object-cover" src="{{ asset('images/background.jpg') }}" alt="bg">
    <div class="bg-black opacity-25 absolute inset-0"></div>
    <div class="h-full relative w-full md:w-[1228px] mx-auto">
        <div class="absolute h-full top-[174px] ">
            ...
            <a class="md:px-[5em] md:py-[1em] px-[3em] py-[.5em] font-semibold  rounded-sm bg-[#ECEAEA] text-center" href="#">Get Started</a>
        </div>
        <div class="w-[418px] hidden md:block h-[418px] absolute right-[76px] top-[143px]">
            <img class="h-full w-full" src="{{ asset('images/logo.webp') }}" alt="">
        </div>
    </div>
