    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        <div data-aos="fade-left" class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-last lg:h-full">
          <img
            alt="ofw"
            src="https://filipinotimes.net/wp-content/uploads/2017/01/OFWs-1.jpg"
...
<section class="mt-6 text-[#333]">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
        <div data-aos="fade-right" class="relative h-64 overflow-hidden rounded-lg sm:h-80 lg:order-first lg:h-full">
          <img
            alt="helpinghand"
            src="https://cdn1.tnwcdn.com/wp-content/blogs.dir/1/files/2015/09/helping-hands-heart-charity.jpg"
            class="absolute inset-0 h-full w-full object-cover"
          />
        </div>
