<section  class="md:w-[1228px] w-full min-h-min mx-auto ">
    ...
    <div data-aos="fade-up" data-aos-duration="1300" class="px-5 md:px-0  lg:mt-7">
        <details class="p-2 border text-justify rounded-md w-full">
            ...
            <div class="md:w-[1177px] p-2 text-sm sm:text-base font-['inter']">
                <p>OFW Serbisyo't Kooperatiba and Engr. Ferdenand "Ibraheem" Lawag Sabado, the manager of YaraMay Computer Maintenance Services (YCMS), the inventor himself and copyright/ patent owner of the system are greatly grateful, hugely encouraged and strongly influenced and inspired
                    by Ramon "Ike" Señeres, former member of the Board of Directors of Philippine Charity Sweepstakes Office (PCSO). His legacy of selflessly and tirelessly extending help fellow countrymen in the country and overseas shall be the guiding light and principles of both OFW Serbisyo't Kooperatiba and Engr. Sabado.</p>
            </div>
