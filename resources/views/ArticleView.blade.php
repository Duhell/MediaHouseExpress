...
<div class="w-full h-80">
    <img class="w-full object-cover object-center h-full" src="https://images.unsplash.com/photo-1585829365295-ab7cd400c167?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="">
</div>
...
<div class="mt-8 container mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        @php
            $tests = ['sdsdd','dsdsds','dsdsdsd','dsdds']
        @endphp
            ...
            <div class="max-w-xl overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div class="p-6">
                    <div>
                        ...
                        <a href="{{ route('articles',1) }}" class="block mt-2 text-xl font-semibold text-gray-800 transition-colors duration-300 transform dark:text-white hover:text-gray-600 hover:underline" tabindex="0" role="link">I Built A Successful Blog In One Year</a>
