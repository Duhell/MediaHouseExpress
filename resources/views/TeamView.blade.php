            ...
            <div class="card-body">
              ...
              <p class="text-center">Founder</p>
                <div class="leading-relaxed">
                    ...
                    <p>Graduate of Bachelor of Science in Information Technology</p>
                    <p>Studied Bachelor of Science in Information Technology</p>
                    <p>Microsoft Certified with License</p>
                    <p>Cisco Certified with License</p>
                    <p>TESDA ASSESSOR for Computer Hardware</p>
                    <p>Working at King Khalid Military City in Saudi Arabia</p>
                </div>
                <div class="py-5 flex items-center gap-x-[26px] justify-center">
                    ...
                    <a href=""><iconify-icon icon="ant-design:instagram-filled" width="32" height="32"></iconify-icon></a>
                    <a href=""><iconify-icon icon="simple-icons:x" width="32" height="32"></iconify-icon></a>
                </div>
            </div>
        </div>
